...
/**
* PrathamCalculator/CalcPOA.java .
...
public abstract class CalcPOA extends org.omg.PortableServer.Servant
 implements PrathamCalculator.CalcOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  //Performs the Calculations:ADD/SUB/MUL/DIV
       case 0:  // PrathamCalculator/Calc/calculate
       {
  ...
  //The Server EXITS when the Client prompts it to do so
       case 1:  // PrathamCalculator/Calc/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
